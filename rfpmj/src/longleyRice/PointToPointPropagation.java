...
public class PointToPointPropagation {
	public void point_to_point(double elev[], double tht_m, double rht_m,
			...
			double rel, double dbloss, String strmode, int errnum) // TODO: Fix
																	// Pointers
	...
	public void point_to_pointMDH(double elev[], double tht_m, double rht_m,
			double eps_dielect, double sgm_conductivity, double eno_ns_surfref,
			double frq_mhz, int radio_climate, int pol, double timepct,
			double locpct, double confpct, double dbloss, int propmode,
